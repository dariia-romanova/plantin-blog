      ...
      <div className="title-section__wrapper">
        <div className="title-section__content">
          <div className="title-section__info">
            <h2 className="title-section__title">
              Stay always tuned with planting trends
            </h2>
            {isMobile ? (
              <p className="title-section__subtitle">
                <span className="title-section__bold">Tips &amp; Tricks</span>{" "}
                selected specially for{" "}
                <span className="title-section__bold">you!</span>
              </p>
            ) : (
              <p className="title-section__temperature">
